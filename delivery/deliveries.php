...
<body>
    ...
    <div class="container p-3 d-flex flex-column align-items-center">
        <form class="d-flex my-2 my-lg-0">
            <a href="./manageDelivery.php?model=new_delivery" class="btn btn-light my-2 my-sm-0"
            type="submit" style="font-weight:bolder;color:black;">
            Adicionar Ruta</a>
        </form>
    </div>
    <div class="p-5 d-flex flex-column align-items-left">  
        <input type="text" id="search_input" onkeyup="searchDeliveryTable()" placeholder="Buscar por ID..">
